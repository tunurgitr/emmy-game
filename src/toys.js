...
export const TOYS = [
  ...
  { id: "stickyhand",name: "Sticky Hand",     emoji: "🖐️",  value: 14,  tier: "common",    play: "stretch", model3d: { shape: "hand", finish: "goo", colors: ["#7cfc00","#b8ff70"] } },
  // ---- Uncommon ----
  ...
  { id: "wave",      name: "Liquid Motion",   emoji: "🌊",  value: 68,  tier: "rare",      play: "flick", parts: ["💧","🔵","🟣"], model3d: { shape: "orb", finish: "glass", colors: ["#3d8bfd","#ff5da2","#ffffff"], params: { bubbles: true } } },
  ...
  { id: "unicorn",   name: "Unicorn Squish",  emoji: "🦄",  value: 110, tier: "epic",      play: "squish",  parts: ["🌈","⭐","🦄"], model3d: { shape: "ball", finish: "plush", colors: ["#ffd1dc","#e6ccff","#bfeaff","#fff8dc"], cute: true, params: { horn: true, ears: true } } },
  ...
  { id: "lavalamp",  name: "Lava Lamp",       emoji: "🫙",  value: 120, tier: "epic",      play: "flick",   parts: ["🔴","🟠","🟣"], model3d: { shape: "capsule", finish: "glass", colors: ["#ff4500","#ff8c00","#4b0082"], params: { lava: true } } },
  ...
  { id: "avocado",   name: "Avocado Squish",  emoji: "🥑",  value: 15,  tier: "common",    play: "squish",  parts: ["🥑","💚"], model3d: { shape: "ball", finish: "silicone", colors: ["#4caf78","#ffe14d","#8b5a2b"], cute: true, params: { ovoid: true, pit: true } } },
